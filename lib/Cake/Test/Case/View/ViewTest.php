 ...
 */
	public function testGetTemplate() {
		...
		$this->Controller->viewPath = 'Index';
		$this->Controller->action = 'display';
		$this->Controller->params['pass'] = array('home');

		$ThemeView = new TestThemeView($this->Controller);
		$ThemeView->theme = 'test_theme';
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Index' . DS . 'home.ctp';
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Index' . DS . 'page.home.ctp';
 ...
 */
	public function testMissingView() {
		...
		$this->ThemeController->name = 'Index';
		$this->ThemeController->viewPath = 'Index';
 ...
 */
	public function testViewFileName() {
		...
		$result = $View->getViewFileName('/Index/home');
		$this->assertRegExp('/Index(\/|\\\)home.ctp/', $result);
